...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.C_MASK {0x00000000C0008000} \
 ] $dlmb_cntlr
  ...
  set_property -dict [ list \
   CONFIG.C_MASK {0x0000000080008000} \
 ] $ilmb_cntlr
  ...
  create_bd_addr_seg -range 0x00002000 -offset 0x00008000 [get_bd_addr_spaces microblaze_I/Data] [get_bd_addr_segs second_dlmb_cntlr/SLMB/Mem] SEG_second_dlmb_cntlr_Mem
  create_bd_addr_seg -range 0x00002000 -offset 0x00008000 [get_bd_addr_spaces microblaze_I/Instruction] [get_bd_addr_segs second_ilmb_cntlr/SLMB/Mem] SEG_second_ilmb_cntlr_Mem
