...
HD_PWD='C:/Users/austi/decoder_1/decoder_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log proj0_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source proj0_top.tcl
