...
HD_PWD='C:/Users/austi/decoder_1/decoder_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log proj0_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source proj0_top.tcl -notrace
